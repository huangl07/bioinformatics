...
while (<In>) {
	chomp;
	next if ($_ eq ""||/^$/);
	my (undef,$MutInfo,$MutType,undef,undef,undef,undef,undef,undef,undef,undef,$chr,$pos,undef,$ref,$alt,undef,undef,undef,$GT,@info)=split(/\t/,$_);
	$pos=join("\t",$chr,$pos);
	my @pos;
...
while (<In>) {
	chomp;
	next if ($_ eq "" ||/^$/);
	my ($postion,$geneID,undef,undef,undef,undef,undef,undef,undef,undef,$chr,$pos,undef,$ref,$alt,undef,undef,undef,$GT,@info)=split(/\t/,$_);
	$pos=join("\t",$chr,$pos);
