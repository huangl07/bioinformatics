...
open SH,">$dShell/step10.cnv-calling.sh";
open In,$bamlist;
...
close SH;
close Out;
my $job="perl /mnt/ilustre/users/dna/.env//bin/qsub-sge.pl  --Resource mem=3G --CPU 1 --maxjob $proc $dShell/step10.cnv-calling.sh";
`$job`;
#######################################################################################
