...
open In,$clist;
open SH,">$dShell/step03.sstacks.sh";
...
close SH;
close Out;
my $job="perl /mnt/ilustre/users/dna/.env//bin//qsub-sge.pl --Queue dna --Resource mem=20G --CPU 8 --Nodes 1 $dShell/step03.sstacks.sh";
print "$job\n";
`$job`;
print "$job\tdone!\n";
