...
$dep||=2;
$mis=1-$mis;
open SH,">$dsh/step01.vcf-convert1.sh";
open List,">$out/vcf.list";
print SH "perl $Bin/bin/vcf2hapmap.pl -i $vcf -o $out/pop.hapmap";
close SH;
my $job="perl /mnt/ilustre/users/dna/.env//bin//qsub-sge.pl $dsh/step01.vcf-convert1.sh";
`$job`;
