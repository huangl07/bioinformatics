...
close In;
close Out;
print SH "java -Djava.io.tmpdir=$dOut/tmp/ -Xmx120G -jar /mnt/ilustre/users/dna/.env/bin/GenomeAnalysisTK.jar -T GenotypeGVCFs -V $dOut/gvcf.list  -o $dOut/pop.noid.vcf -R $ref -log $dOut/pop.variant.log -jdk_deflater -jdk_inflater && ";
