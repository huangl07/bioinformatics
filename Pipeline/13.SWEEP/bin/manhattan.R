...
par(mfrow = c(3, 1))
manhattan(data,chr="chr",bp="pos",p="pi1",col=rainbow(4),chrlabs=chrlab,ylab="Pi",logp=TRUE,suggestiveline=quantile(data$pi1,prob=0.05),type="l")
box()
manhattan(data,chr="chr",bp="pos",p="tajima1",col=rainbow(4),chrlabs=chrlab,ylab="TajimaD",logp=FALSE,ylim=c(-1*ylimit,ylimit),type="l")
box()
manhattan(data,chr="chr",bp="pos",p="fst",col=rainbow(4),chrlabs=chrlab,ylab="Fst",logp=FALSE,suggestiveline=quantile(data$fst,prob=0.05),type="h")
box()
dev.off()
pdf(paste(opt$out,"pop2.manhattan.pdf",sep="."),height=12,width=16)
par(mfrow = c(3, 1))
manhattan(data,chr="chr",bp="pos",p="pi2",col=rainbow(4),chrlabs=chrlab,ylab="Pi",logp=TRUE,suggestiveline=quantile(data$pi1,prob=0.05),type="l")
box()
manhattan(data,chr="chr",bp="pos",p="tajima2",col=rainbow(4),chrlabs=chrlab,ylab="TajimaD",logp=FALSE,,ylim=c(-1*ylimit,ylimit),type="l")
box()
manhattan(data,chr="chr",bp="pos",p="fst",col=rainbow(4),chrlabs=chrlab,ylab="Fst",ylim=c(0,1),logp=FALSE,suggestiveline=quantile(data$fst,prob=0.95),type="h")
box()
dev.off()
...
manhattan(data,chr="chr",bp="pos",p="pi1",col=rainbow(4),chrlabs=chrlab,ylab="Pi",logp=TRUE,suggestiveline=quantile(data$pi1,prob=0.05),type="l")
box()
manhattan(data,chr="chr",bp="pos",p="tajima1",col=rainbow(4),chrlabs=chrlab,ylab="TajimaD",logp=FALSE,ylim=c(-1*ylimit,ylimit),suggestiveline=quantile(data$tajima1,prob=0.95),type="l")
box()
manhattan(data,chr="chr",bp="pos",p="fst",col=rainbow(4),chrlabs=chrlab,ylab="Fst",logp=FALSE,suggestiveline=quantile(data$fst,prob=0.95),type="h")
box()
dev.off()
