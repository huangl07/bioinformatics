...
open In,$clist;
open SH,">$dShell/step08.rsstacks.sh";
...
close SH;
close Out;
my $job="perl /mnt/ilustre/users/dna/.env//bin//qsub-sge.pl --Queue dna --Resource mem=100G --CPU 8 --Nodes 1 --Maxjob $proc $dShell/step08.rsstacks.sh";
print "$job\n";
`$job`;
print "$job\tdone!\n";
