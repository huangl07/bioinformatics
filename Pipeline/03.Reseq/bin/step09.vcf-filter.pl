...
print SH "java -Xmx20G -jar /mnt/ilustre/users/dna/.env/bin/GenomeAnalysisTK.jar -T SelectVariants -R $ref -V $vcf -nt 8 -selectType SNP  -o $dOut/pop.snp.vcf -log $dOut/pop.selectSNP.log && ";
...
print SH "java -Xmx20G -jar /mnt/ilustre/users/dna/.env/bin/GenomeAnalysisTK.jar -T SelectVariants -R $ref -nt 8 -V $dOut/pop.snp.filter.vcf -o $dOut/pop.snp.filter.recode.vcf --setFilteredGtToNocall --excludeFiltered --excludeNonVariants -log $dOut/pop.filterSNP.log \n";
print SH "java -Xmx20G -jar /mnt/ilustre/users/dna/.env/bin/GenomeAnalysisTK.jar -T SelectVariants  -R $ref -nt 8 -V $vcf -selectType INDEL  -o $dOut/pop.indel.vcf -log $dOut/pop.selectINDEL.log && ";
...
print SH "java -Xmx20G -jar /mnt/ilustre/users/dna/.env/bin/GenomeAnalysisTK.jar -T SelectVariants  -R $ref -nt 8 -V $dOut/pop.indel.filter.vcf -o $dOut/pop.indel.filter.recode.vcf --setFilteredGtToNocall --excludeFiltered --excludeNonVariants -log $dOut/pop.selectINDEL.log \n";
close SH;
