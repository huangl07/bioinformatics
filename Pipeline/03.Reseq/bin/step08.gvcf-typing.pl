...
close In;
print SH "java -Djava.io.tmpdir=$dOut/tmp/ -Xmx120G -jar /mnt/ilustre/users/dna/.env/bin/GenomeAnalysisTK.jar -T GenotypeGVCFs $vcf -nt 32 -o $dOut/pop.noid.vcf -R $ref -log $dOut/pop.variant.log && ";
