...
`$Bin/matrix2png -data $fOut.matrix -rcd -size 10:10 -mincolor 10:70:243 -midcolor  5:108:20 -maxcolor 100:20:37  -missingcolor grey >$fOut.haplo.png` ;
