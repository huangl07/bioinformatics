...
{	## 全局参数
	...
	chdir $dirname;
	`perl $Bin/drawFlow/distributing_svg.pl "$fKey.RMSD.list" "$fKey.RMSD.list.svg"`;
	`perl $Bin/drawFlow/svg2xxx_release/svg2xxx "$fKey.RMSD.list.svg"`;
...
#	print OUT "MultiY:1\n";
	...
	chdir $dirname;
	`perl $Bin/drawFlow/distributing_svg.pl "$fKey.AFE.list" "$fKey.AFE.list.svg"`;
	`perl $Bin/drawFlow/svg2xxx_release/svg2xxx "$fKey.AFE.list.svg"`;
...
#		print OUT "PointSize:3\n";
		...
		chdir $dirname;
		`perl $Bin/drawFlow/distributing_svg.pl "LG$lg.$sex.poorFit.list" "LG$lg.$sex.poorFit.list.svg"`;
		`perl $Bin/drawFlow/svg2xxx_release/svg2xxx "LG$lg.$sex.poorFit.list.svg"`;
