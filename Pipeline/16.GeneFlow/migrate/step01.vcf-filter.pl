...
print SH "java -jar /mnt/ilustre/users/dna/.env//bin//PGDSpider2-cli.jar -inputfile $out/pop.recode.vcf -inputformat VCF -outputfile $out/pop.migrate -outputformat MIGRATE -spid $Bin/bin/migrate.spid && ";
print SH "mpirun -np 8 /mnt/ilustre/users/dna/.env/bin/migrate-n-mpi $out/parmfile";
close SH;
