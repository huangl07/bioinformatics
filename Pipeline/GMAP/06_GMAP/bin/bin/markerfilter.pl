...
my $BEGIN_TIME=time();
use Getopt::Long;
my ($fIn,$fOut,$popt,$homo,$Geno,$seg,$mis,$fstat,$pos,$opos);
use Data::Dumper;
...
Usage:
  ...
  -s	<file>	output statistic file name
  -f	<file>	output filtered stat file name
  -g	<file>	output filtered genotype file name
  -p	<str>	population type CP/BCi/Fi/Rix/
