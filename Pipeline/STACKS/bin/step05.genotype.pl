...
open SH,">$dShell/step04.genotype.sh";
print SH "populations -P $dIn -t 8 -m 4 -O $dOut/ --vcf ";
close SH;
my $job="perl /mnt/ilustre/users/dna/.env//bin//qsub-sge.pl --Queue dna --Resource mem=80G --CPU 8 --Nodes 1 $dShell/step04.genotype.sh";
print  "$job\n";
`$job`;
print "$job\tdone!\n";
