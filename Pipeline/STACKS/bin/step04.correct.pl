...
close In;
open In,$slist;
open SH,">$dShell/step04.correct2.sh";
...
close List;
close In;
open SH,">$dShell/step04.correct1.sh";
...
my $job="perl /mnt/ilustre/users/dna/.env//bin//qsub-sge.pl --Queue dna --Resource mem=80G --CPU 16 --Nodes 1 $dShell/step04.correct1.sh";
print  "$job\n";
`$job`;
print "$job\tdone!\n";
my $job="perl /mnt/ilustre/users/dna/.env//bin//qsub-sge.pl --Queue dna --Resource mem=80G --CPU 16 --Nodes 1 $dShell/step04.correct2.sh";
print  "$job\n";
`$job`;
print "$job\tdone!\n";
