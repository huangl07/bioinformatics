...
open In,$fqlist;
open SH,">$dShell/step03.rawdata-dup.sh";
...
my $job="perl /mnt/ilustre/users/dna/.env/bin/qsub-sge.pl  $dShell/step03.rawdata-dup.sh --Resource mem=3G --CPU 1  --Nodes 1 --Maxjob 19 ";
`$job`;
#######################################################################################
