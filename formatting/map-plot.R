...
Options:
	...
	-i, --id	id list file [optional], these will plot with red.
...
outpdf=paste(opt$dir,"/figure_3_9_",opt$fkey,".pdf",sep="")
pdf(outpdf,width=w)
plotlink(m)
dev.off()

outpng=paste(opt$dir,"/figure_3_9_",opt$fkey,".png",sep="")
